  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Obx(
           () {
            return Container(
                  color: controller.isLoading.value ?  AppColors.primaryColor : Colors.white,
                  child: Stack(
                    children: [
                      Visibility(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CustomTextWidget(text: "Esqueceu sua senha? "),
                                        InkWell(
                                          onTap: () {
            ...
            return Visibility(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    CustomTextWidget(text: "Ainda não tem cadastro?"),
                    SizedBox(width: 2),
                    GestureDetector(
                        onTap: () {},
                        child: CustomTextWidget(
                            text: "Criar", fontWeight: FontWeight.w700)),
                    SizedBox(
                        height: 30,
                        width: 50,

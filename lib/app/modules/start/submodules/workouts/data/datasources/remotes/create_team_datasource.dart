import 'package:treinif/app/modules/start/submodules/workouts/data/dtos/team_dto.dart';
...
class CreateTeamDataSource implements ICreateTeamDataSource{
  ...
  Future<ReturnData<TeamEntity>> call(TeamEntity team) async {
    try{
      ...
      final response = await _client.post("/teams", data: TeamDTO(name: team.name, description: team.description, code: team.code, modality: team.modality).toJson());

                    ...
                    Column(
                      children: [
                        ...
                        CustomDropdownButton(
                          ...
                          isDense: true,
                          hint: Text(controller.exerciseTypeSelected.value?.name ?? "Exercicios"),
                          items:  controller.exercisesTypes.map((element) => DropdownMenuItem(
                            value: element,
                      ...
                      child: Row(
                        ...
                        children: [
                          CustomButtonWidget(
                            ...
                            onPressed: (){
                              controller.addExercise(int.parse(Get.parameters["workout_id"] as String), ExerciseClassificationEnum.individual.value);
                            },

...
class AthleteProfileBiding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => AddIndividualWorkoutRepository(Get.find<AddIndividualWorkoutDataSource>()));
    Get.lazyPut(() => AddIndividualWorkoutUseCase(Get.find<AddIndividualWorkoutRepository>()));
    ...
    Get.lazyPut(() => GetAllIndividualWorkoutsDataSource(Get.find<CustomDio>()));
    Get.lazyPut(() => GetAllIndividualWorkoutsRepository(Get.find<GetAllIndividualWorkoutsDataSource>()));
    Get.lazyPut(() => GetAllIndividualWorkoutsOfAthleteUseCase(Get.find<GetAllIndividualWorkoutsRepository>()));
    
    Get.lazyPut(() => UpdateDateDataPointOfHistoricOfAthleteDataSource(Get.find<CustomDio>()));
    Get.lazyPut(() => UpdateDateDataPointOfHistoricOfAthleteRepository(Get.find<UpdateDateDataPointOfHistoricOfAthleteDataSource>()));
    Get.lazyPut(() => UpdateDateDataPointOfHistoricOfAthleteUseCase(Get.find<UpdateDateDataPointOfHistoricOfAthleteRepository>()));
    
    Get.lazyPut(() => UpdateIndividualWorkoutNameDataSource(Get.find<CustomDio>()));
    Get.lazyPut(() => UpdateIndividualWorkoutNameRepository(Get.find<UpdateIndividualWorkoutNameDataSource>()));
    Get.lazyPut(() => UpdateIndividualWorkoutNameUseCase(Get.find<UpdateIndividualWorkoutNameRepository>()));
    
    Get.lazyPut(() => UpdateIndividualWorkoutStatusDataSource(Get.find<CustomDio>()));
    Get.lazyPut(() => UpdateIndividualWorkoutStatusRepository(Get.find<UpdateIndividualWorkoutStatusDataSource>()));
    Get.lazyPut(() => UpdateIndividualWorkoutStatusUseCase(Get.find<UpdateIndividualWorkoutStatusRepository>()));

    Get.lazyPut(() => RemoveDataPointOfHistoricOfAthleteDataSource(Get.find<CustomDio>()));
    Get.lazyPut(() => RemoveDataPointOfHistoricOfAthleteRepository(Get.find<RemoveDataPointOfHistoricOfAthleteDataSource>()));
    Get.lazyPut(() => RemoveDataPointOfHistoricOfAthleteUseCase(Get.find<RemoveDataPointOfHistoricOfAthleteRepository>()));
    
    Get.lazyPut(() => RemoveIndividualWorkoutDataSource(Get.find<CustomDio>()));
    Get.lazyPut(() => RemoveIndividualWorkoutRepository(Get.find<RemoveIndividualWorkoutDataSource>()));
    Get.lazyPut(() => RemoveIndividualWorkoutUseCase(Get.find<RemoveIndividualWorkoutRepository>()));

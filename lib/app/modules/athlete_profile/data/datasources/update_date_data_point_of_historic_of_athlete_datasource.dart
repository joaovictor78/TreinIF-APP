...
class UpdateDateDataPointOfHistoricOfAthleteDataSource implements IUpdateDateDataPointOfHistoricOfAthleteDataSource{
  UpdateDateDataPointOfHistoricOfAthleteDataSource(this._client);
  IHttpClient _client;
  @override

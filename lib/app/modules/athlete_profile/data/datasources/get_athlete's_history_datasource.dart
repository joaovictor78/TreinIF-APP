...
class GetAthletesHistoryDataSource implements IGetAthletesHistoryDataSource{
  ...
  Future<ReturnData<List<DataPointOfAthleteHistoricEntity>>> call(int athleteID) async {
     try{
       ...
       List<DataPointOfAthleteHistoricEntity>  dataPoints = (_response.data["data_points"] as List).map((dataPoint) => DataPointOfAthleteHistoricDTO.fromJson(dataPoint)).toList(); 

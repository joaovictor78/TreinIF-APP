...
import 'package:treinif/app/core/enums/user_types_enum.dart';
...
class LoggedUserModel {
  ...
  factory LoggedUserModel.fromMap(Map<String, dynamic> map) {
    return LoggedUserModel(
      user: map['user'] == null ? null : map["user"]["role_id"] == UserTypesEnum.athlete ? AthleteModel.fromMap(map['user']) : UserModel.fromMap(map['user']),
  ...
  factory LoggedUserModel.fromJson(String source) => LoggedUserModel.fromMap(json.decode(source));
}
